...
import MyDarkImage from '@/public/fb.svg';
  ...
  return (
    <NavigationMenu>
      <NavigationMenuList className="gap-15 2xl:gap-x-8 justify-center">
        <NavigationMenuItem>
          <NavigationMenuTrigger className="dark:text-zinc-100 font-medium text-lg dark:hover:bg-accent dark:hover:text-accent-foreground dark:focus:bg-accent dark:focus:text-accent-foreground">Proyectos</NavigationMenuTrigger>
                ...
                <NavigationMenuLink asChild>
                  <a className="flex h-full w-full select-none flex-col justify-end rounded-md bg-gradient-to-b from-muted/50 to-muted p-6 no-underline outline-none focus:shadow-md" href="/">
                    <div className="mb-2 mt-4 text-lg font-medium">
                      <Image src="/fb.svg" width={150} height={150} alt="logo" />
                    </div>
        ...
        <NavigationMenuItem>
          <NavigationMenuTrigger className="dark:text-zinc-100 font-medium text-lg dark:hover:bg-accent dark:hover:text-accent-foreground dark:focus:bg-accent dark:focus:text-accent-foreground">Facturación</NavigationMenuTrigger>
          <NavigationMenuContent>
